        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Destinatarios_Enderecos_EnderecoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Emitentes_Enderecos_EnderecoId",
                        column: x => x.EnderecoId,
                        principalTable: "Enderecos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotaFiscals_Destinatarios_DestinatarioId",
                        column: x => x.DestinatarioId,
                        principalTable: "Destinatarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NotaFiscals_Emitentes_EmitenteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_NotaFiscals_NotaFiscalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotaItems", x => new { x.NotaFiscalId, x.ItemId });
                    table.ForeignKey(
                        name: "FK_NotaItems_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotaItems_NotaFiscals_NotaFiscalId",
                        column: x => x.NotaFiscalId,
                        principalTable: "NotaFiscals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Destinatarios_EnderecoId",
                table: "Destinatarios",
                column: "EnderecoId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotaFiscals_DestinatarioId",
                table: "NotaFiscals",
                column: "DestinatarioId");

            migrationBuilder.CreateIndex(
                name: "IX_NotaFiscals_EmitenteId",
                table: "NotaFiscals",
                column: "EmitenteId");

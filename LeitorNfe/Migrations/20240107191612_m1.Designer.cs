...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeitorNfe.Models.Destinatario", b =>
                {
                    b.HasOne("LeitorNfe.Models.Endereco", "Endereco")
                        .WithOne()
                        .HasForeignKey("LeitorNfe.Models.Destinatario", "EnderecoId")
            ...
            modelBuilder.Entity("LeitorNfe.Models.Emitente", b =>
                {
                    b.HasOne("LeitorNfe.Models.Endereco", "Endereco")
                        .WithOne()
                        .HasForeignKey("LeitorNfe.Models.Emitente", "EnderecoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LeitorNfe.Models.Item", b =>
                {
                    b.HasOne("LeitorNfe.Models.NotaFiscal", null)
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("LeitorNfe.Models.NotaFiscal", b =>
                {
                    b.HasOne("LeitorNfe.Models.Destinatario", "Destinatario")
                        .WithMany("NotasFiscais")
                        .HasForeignKey("DestinatarioId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LeitorNfe.Models.Emitente", "Emitente")
                        .WithMany("NotasFiscais")
            ...
            modelBuilder.Entity("LeitorNfe.Models.NotaItem", b =>
                {
                    b.HasOne("LeitorNfe.Models.Item", "Item")
                        .WithMany("NotaItems")
